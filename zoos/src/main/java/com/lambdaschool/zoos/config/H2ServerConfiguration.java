...
public class H2ServerConfiguration
{
     ...
     * <p>
     * Connect to "jdbc:h2:tcp://localhost:9092/mem:testdb", zooname "sa", password empty.
     *
     ...
     * <p>
     * Go to http://localhost:8082 and connect to the database "jdbc:h2:mem:testdb", zooname "sa", password empty.
     *
